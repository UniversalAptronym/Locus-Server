...
Raspberry Pi Zero 2 W. (left) Bare motherboard. (Middle) Motherboard with thermal plastic contacts, which help conduct heat away from the board and into the case. (Right) Pi Zero 2 W fully enclosed in case.
