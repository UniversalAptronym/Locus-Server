...
9. [Set up Nginx](Instructions/Nginx+Cloudflared+Ports_Setup_(Web_Connection).md), which lets you and others connect to Nextcloud / Databag remotely over the internet.
