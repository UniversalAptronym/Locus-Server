...
9. [Set up Nginx, Cloudflared (not to be confused with Cloudflare), and port-forwarding](Instructions/Nginx+Cloudflared+Ports_Setup_(Web_Connection).md), which lets you and others connect to Nextcloud / Databag remotely over the internet.
